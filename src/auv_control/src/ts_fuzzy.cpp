...
TSFuzzyController::TSFuzzyController() {
  // Gains tuned for the corrected B matrix (u1→surge, u2→heave, u3→pitch×0.5m,
  // u4→yaw×0.5m) and vehicle drag (drag_u=25, drag_r=15, drag_w=60).
  // ku/kw must overcome linear drag; kr must produce tau_n = kr*0.5 >> drag_r.
  //                        ku     kw     kq     kr
  K_[0] = make_gain(150.0, 120.0, 40.0, 160.0);   // Rule 1: theta1=0.5, theta2=-0.1
  K_[1] = make_gain(150.0, 120.0, 40.0, 140.0);   // Rule 2: theta1=0.5, theta2= 0.0
  K_[2] = make_gain(150.0, 120.0, 40.0, 160.0);   // Rule 3: theta1=0.5, theta2= 0.1
  K_[3] = make_gain(180.0, 120.0, 50.0, 150.0);   // Rule 4: theta1=1.0, theta2=-0.1
  K_[4] = make_gain(180.0, 120.0, 50.0, 120.0);   // Rule 5: theta1=1.0, theta2= 0.0
  K_[5] = make_gain(180.0, 120.0, 50.0, 150.0);   // Rule 6: theta1=1.0, theta2= 0.1
}
