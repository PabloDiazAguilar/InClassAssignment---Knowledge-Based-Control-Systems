...
def generate_launch_description():
    ...
    # Keep this short: the controller doesn't act until have_odom_=true, but
    # Gazebo applies gravity from t=0 and buoyancy only comes from the controller.
    # At 3 s the AUV was reaching the seabed (z=-20 m); 1 s limits the fall to ~5 m.
